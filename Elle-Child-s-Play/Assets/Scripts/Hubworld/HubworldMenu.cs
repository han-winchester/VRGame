...
public class HubworldMenu : MonoBehaviour
{
    ...
    public Image leftHandedButton, rightHandedButton, teleportButton, continuousButton, logoutPanel;
    ...
    void Update()
    {
        bool leftHandHovered, rightHandHovered, teleportHovered, continuousHovered, logoutHovered;
        bool leftHandSelected, rightHandSelected, teleportSelected, continuousSelected;
        RaycastHit hit;

        leftHandHovered = rightHandHovered = teleportHovered = continuousHovered = logoutHovered = false;
